...
$filename= "backups/backup_". $_SESSION["id_usuario"] ."_". $agora .".bak";
$filename_zip= "backups/backup_". $_SESSION["id_usuario"] ."_". $agora .".zip";
...
if (file_exists($dir . $filename_zip)) {
	...
	if (!$upload) { */
		...
		echo "<p>Backup criado, <a href=\"". $dir . $filename_zip ."\">clique aqui</a> e salve esse arquivo localmente!</p>";
	//} else {
