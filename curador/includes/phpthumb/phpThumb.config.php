...
$PHPTHUMB_CONFIG['high_security_password']      = 'busca1414';      // required if 'high_security_enabled' is true, and must be at complex (uppercase, lowercase, numbers, punctuation, etc -- punctuation is strongest, lowercase is weakest; see PasswordStrength() in phpThumb.php). You can use a password generator like http://silisoftware.com/tools/password-random.php to generate a strong password
...
$PHPTHUMB_CONFIG['nohotlink_text_message']      = 'qwe Off-server thumbnailing is not allowed'; // text of error message
