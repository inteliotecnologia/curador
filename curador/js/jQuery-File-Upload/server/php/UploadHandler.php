...
class UploadHandler
{
    ...
    public function __construct($options = null, $initialize = true, $error_messages = null) {
        $this->options = array(
            ...
            'upload_dir' => '/var/www/custom/curador.norte.art.br/html/uploads/uploads_fu/',
            //'upload_url' => $this->get_full_url().'/files/',
            'upload_url' => 'http://curador.norte.art.br/curador/uploads/uploads_fu/',
    ...
    protected function handle_file_upload($uploaded_file, $name, $size, $type, $error,
	    ...
	    //echo "processando arquivo $uploaded_file / $name no back-end\n";
    ...
    public function post($print_response = true) {
        ...
        //die("movido $uploaded_file para $file_path !!! ");
        ...
        //if (!empty($_FILES)) {
			...
			//echo "auth gerado eh $auth ";
			
			
			//if ($_POST["tipo_imagem"]=="a") {
				
				//echo "iniciando S3 com key: ". S3_KEY ." para bucket ". BUCKET_CURADOR ." |||| ";
				...
				$tempFile = $files[0]->name;
				$targetPath = BUCKET_CURADOR . '/'. $_GET["tipo_imagem"] .'_'. $_GET["id_externo"] .'/';
				...
				$targetFilename= $auth ."_". retira_acentos($files[0]->name);
				$targetFile =  str_replace('//','/',$targetPath) . $targetFilename;
				
				$targetExtension= pathinfo($files[0]->name, PATHINFO_EXTENSION);
				...
				//if (!file_exists("/var/www/custom/curador.norte.art.br/html/uploads/uploads_fu/". $tempFile)) echo " XXX ARQ NAO EXISTE XXX ";
				
				$envia_s3= $s3->putObjectFile("/var/www/custom/curador.norte.art.br/html/uploads/uploads_fu/". $tempFile, $bucket, $targetFile, S3::ACL_PUBLIC_READ);
				
				if ($envia_s3) {
					
					//echo "enviou s3 para $targetFile ";
					...
					//move_uploaded_file($tempFile, $targetFile);
						...
						switch ($targetExtension) {
				            case 'jpg':
				            case 'jpeg':
				                $originalimage= imagecreatefromjpeg("/var/www/custom/curador.norte.art.br/html/uploads/uploads_fu/". $tempFile);
				                break;
				            case 'gif':
				                $originalimage= imagecreatefromgif("/var/www/custom/curador.norte.art.br/html/uploads/uploads_fu/". $tempFile);
				                break;
				            case 'png':
				                $originalimage= imagecreatefrompng("/var/www/custom/curador.norte.art.br/html/uploads/uploads_fu/". $tempFile);
				                break;
				            default:
				                return false;
				        }
					...
					$ordem= pega_ultima_ordem_imagens($_GET["tipo_imagem"], $_GET["id_externo"]);
					...
					$result_insere= mysql_query("insert into imagens
													...
													values
													('". $_GET["tipo_imagem"] ."', '". $_GET["id_externo"] ."', '". $_SESSION["id_empresa"] ."', '". $targetFilename ."', '". $ordem ."', '',
													'". $dimensao_imagem ."', '". $l_original ."', '". $a_original ."', '". $_SESSION["id_usuario"] ."')
													");
					$id_imagem= mysql_insert_id();
					
					unlink("/var/www/custom/curador.norte.art.br/html/uploads/uploads_fu/". $tempFile);
